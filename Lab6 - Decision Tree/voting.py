...
if __name__ == '__main__':
    ...
    test_set = [[float(x) for x in input().split(', ')]]
    ...
    for x, y in zip(test_x, test_y):
        y_predicted_1 = classifier1.predict([x])[0]
        y_predicted_2 = classifier1.predict([x])[0]
        y_predicted_3 = classifier1.predict([x])[0]

        votes[y_predicted_1] = votes[y_predicted_1] + 1
        votes[y_predicted_2] = votes[y_predicted_2] + 1
        votes[y_predicted_3] = votes[y_predicted_3] + 1

    print(f'Glasovi: {votes}')
    print(f'Predvidena klasa: {max(votes, key=votes.get)}')
